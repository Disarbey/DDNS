...
currentDNSRecord=$(curl -s -G -d 'version=1' -d 'type=xml' -d 'key=76296bf250176aedad32724' -d 'domain=disarbey.com' https://www.namesilo.com/api/dnsListRecords)
...
curl -s -G -d 'version=1' -d 'type=xml' -d 'key=76296bf250176aedad32724' -d 'domain=disarbey.com' -d 'rrtype=A' -d 'rrhost=naonas' -d 'rrvalue='$currentIP'' -d 'rrttl=3603' https://www.namesilo.com/api/dnsAddRecord
...
do
if test -n "$(echo $tmp_DNSrecord | grep -o 'naonas')";
then
# save the record_id
...
curl -s -G -d 'version=1' -d 'type=xml' -d 'key=76296bf250176aedad32724' -d 'domain=disarbey.com' -d 'rrid='$record_id'' -d 'rrhost=naonas' -d 'rrvalue='$currentIP'' -d 'rrttl=3603' https://www.namesilo.com/api/dnsUpdateRecord
